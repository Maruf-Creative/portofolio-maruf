...
export function HomePage() {
  ...
  return (
    <div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="max-w-3xl">
            <h1 className="text-4xl sm:text-5xl lg:text-6xl text-gray-900 dark:text-white mb-6">
              Solusi Pemasaran & Desain Digital
            </h1>
      ...
      {/* Stats Section */}
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-white dark:bg-slate-800 border-y border-gray-200 dark:border-gray-700 transition-colors">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <div className="text-3xl font-semibold text-gray-900 dark:text-white mb-2">25%+</div>
              <div className="text-gray-600 dark:text-gray-300">Rata-rata Pertumbuhan Interaksi</div>
            </div>
            <div className="text-center">
              ...
              <div className="text-3xl font-semibold text-gray-900 dark:text-white mb-2">500K+</div>
              <div className="text-gray-600 dark:text-gray-300">Total Jangkauan Dicapai</div>
            </div>
            <div className="text-center">
              <div className="inline-flex items-center justify-center w-12 h-12 bg-purple-100 dark:bg-purple-900/30 text-purple-600 dark:text-purple-400 rounded-xl mb-4">
                <Award size={24} />
              </div>
              <div className="text-3xl font-semibold text-gray-900 dark:text-white mb-2">10+</div>
              <div className="text-gray-600 dark:text-gray-300">Proyek Berhasil</div>
            </div>
          </div>
        </div>
      </section>
